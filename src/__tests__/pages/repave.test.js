...
describe("Repave Page Component", () => {
  ...
  test("Filter Component", async () => {
    ...
    expect(screen.getByRole("button", { name: "TRIGGER REPAVE" }));
  });
  test("RepavePage Component no server", async () => {
  ...
  test("RepavePage Component with mocked data", async () => {
